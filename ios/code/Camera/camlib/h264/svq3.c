...
inline int svq3_decode_block (GetBitContext *gb,
									 DCTELEM *block,
...
inline void svq3_mc_dir_part (MpegEncContext *s,
 ...
 inline int svq3_mc_dir (H264Context *h, int size, int mode, int dir, int avg) {
