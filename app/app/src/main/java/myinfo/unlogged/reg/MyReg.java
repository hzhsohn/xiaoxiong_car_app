...
public class MyReg extends BaseActivity
{
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.acty_my_reg);
        //
        initToolbar(0,
                R.id.toolbarId,
                null,
    ...
    private View.OnClickListener oNextClick =  new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            {
                // 提示框
                AssertAlert.show(MyReg.this, R.string.alert, R.string.msg_not_null_email);
                return ;
            }

            if (txt2.getText().toString().equals(""))
            {
                AssertAlert.show(MyReg.this,R.string.msg_alert,R.string.msg_not_null_nickname);
                return ;
            }

            Intent intent = new Intent(MyReg.this, MyReg2.class);
