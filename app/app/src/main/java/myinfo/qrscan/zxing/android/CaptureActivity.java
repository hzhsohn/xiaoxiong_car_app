package myinfo.qrscan.zxing.android;
...
import myinfo.qrscan.result.QRAddCtrlDevice;
import myinfo.qrscan.result.QRText;
...
import myinfo.logged.caid.area.CAIDEdit;
import myinfo.logged.caid.area.CAIDEditTitle;
...
public final class CaptureActivity extends Activity implements
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if (fromLiveScan) {
            ...
            else if(pattern2.matcher(stext).matches()) {
                intent = new Intent(CaptureActivity.this, QRAddCtrlDevice.class);
            }
            else
            {
