...
import myinfo.qrscan.zxing.decode.DecodeThread;
import myinfo.qrscan.zxing.view.ViewfinderResultPointCallback;
        ...
        switch (message.what) {
            ...
            case R.id.get_image: {
                ...
                if (compressedBitmap != null) {
                    ...
                    //
                    ImageView iv = activity.findViewById(R.id.img1);
            ...
            case R.id.decode_failed:
                ...
                cameraManager.requestPreviewFrame(decodeThread.getHandler(),
                        R.id.decode);
                Log.v("CaptureActivityHandler", "decode_failed");
                break;
