...
import myinfo.logged.setting.about_softw.AboutSoftware;
...
public class MySetting extends BaseActivity {
    ...
    private View.OnClickListener about_software_click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            //跳到下一个窗体
            Intent intent = new Intent(MySetting.this, AboutSoftware.class);
    ...
    private View.OnClickListener freeback_click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            //跳到下一个窗体
            Intent intent = new Intent(MySetting.this, Feedback.class);
            Bundle bundle = new Bundle();//该类用作携带数据
            intent.putExtras(bundle);//附带上额外的数据
            //带返回结果
            startActivityForResult(intent, 1000);
